...
- token spend: prompt=51650, completion=4982
...
| `financials` | 4 | 5 | 4 | 0.80 | 1.00 | 0.89 | 0.25 |
| `lease` | 4 | 9 | 4 | 0.44 | 1.00 | 0.62 | 0.00 |
| `liegenschaft_compliance` | 1 | 1 | 1 | 1.00 | 1.00 | 1.00 | 0.00 |
| `liegenschaft_financials` | 5 | 6 | 5 | 0.83 | 1.00 | 0.91 | 0.40 |
| `liegenschaft_maintenance` | 1 | 1 | 1 | 1.00 | 1.00 | 1.00 | 0.00 |
| `maintenance` | 7 | 7 | 7 | 1.00 | 1.00 | 1.00 | 0.00 |
...
- `EMAIL-06527` — category 'owner_communication'→'tenant_change'; spurious financials.deposit_return_pending, lease.termination_notice
